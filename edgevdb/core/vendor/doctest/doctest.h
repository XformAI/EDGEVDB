...
#define DOCTEST_TEST_CASE(name) \
    static void DOCTEST_FUNC_##__LINE__(); \
    static doctest::TestRegistrar DOCTEST_REG_##__LINE__(name, DOCTEST_FUNC_##__LINE__); \
    static void DOCTEST_FUNC_##__LINE__()

#define TEST_CASE(name) DOCTEST_TEST_CASE(name)

#define SUBCASE(name) if (doctest::SubcaseSignature DOCTEST_SC_##__LINE__ = doctest::SubcaseSignature(name))
